 ...
 */
public class SingleTaskWithSingleEventTest extends JbpmMigrationRuntimeTest {
    public static final String definition =
            "org/jbpm/migration/scenarios/singleTaskWithSingleEvent/processdefinition.xml";
